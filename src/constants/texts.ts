export const TEXTS = {
  ...
  online: "Online",
  greeting: "Chào bạn!",
  loginPrompt: "Hãy đăng nhập để trải nghiệm các tính năng được cá nhân hóa",
  login: "Đăng nhập",
  ...
  useRegisteredInfo: "Hãy sử dụng thông tin vừa đăng ký để đăng nhập",
  welcome: "Chào mừng bạn đến với Thạch Âm",
  startJourney: "Tạo tài khoản để bắt đầu hành trình của bạn",
