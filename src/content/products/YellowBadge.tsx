  ...
  description: (
    <div className="space-y-4 text-sm tracking-normal text-gray-700 md:text-base md:tracking-wide">
      ...
      <p>
        ...
        Khmer cổ điển. Một chi tiết đồ họa uốn lượn lấy cảm hứng từ các hoa văn
        truyền thống Khmer, có thể là hình ảnh Naga hoặc Kinnari cách điệu, được
        tích hợp khéo léo vào phần chữ hoặc bao quanh nó, tạo điểm nhấn ấn
        tượng.
      </p>
      <p>
