...
const bandana: ProductContent = {
  description: (
    <div className="space-y-4 text-sm tracking-normal text-gray-700 md:tracking-wide">
      ...
      <p>
        ...
        Angkor, ánh nắng chiều hắt lên những phù điêu vàng son. Đó chính là cảm
        hứng bất tận mà nhóm Thạch Âm đã chắt lọc, gửi gắm vào từng sợi vải của
        chiếc khăn bandana đặc biệt này.
      </p>
      <p>
        ...
        đẹp di sản, được thiết kế thủ công đầy tâm huyết trong khuôn khổ môn Đồ
        án Vốn cổ Khmer.
      </p>
      <p>
        Hãy để chiếc khăn này không chỉ là phụ kiện, mà là câu chuyện bạn mang
        theo, là dấu ấn của một nền văn minh rực rỡ, sẵn sàng cùng bạn khám phá
  ...
  instruction: (
    <div className="space-y-4 text-sm tracking-normal text-gray-700 md:tracking-wide">
      ...
      <p>
        Tránh sử dụng thuốc tẩy hoặc giặt máy ở chế độ mạnh, vì có thể làm phai
        màu và ảnh hưởng đến chất vải thủ công.
      </p>
      <p>
