    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          vầy ấm áp trong ngày Tết, được Minh Long gửi gắm trọn vẹn qua Bình hoa
          Xuân Ca. Vẻ đẹp của hai loài hoa đặc trưng hòa quyện như vũ điệu rộn
          ràng mùa xuân. Mai vàng rực rỡ từ phương Nam mang theo lời chúc thịnh
          vượng, trường thọ. Trong khi đào thắm tươi miền Bắc khẽ chạm đến an
          lành, hạnh phúc. Cổ bình điểm xuyết hoa sen, biểu trưng cho tâm hồn
          thuần khiết. Gam màu xanh cobalt dịu mát, kết hợp với viền vàng 24k
          lấp lánh, tạo nên nét trang nhã và quý phái, tô điểm không gian thêm
          sinh động.
        </p>
        <p>
          Bình hoa Xuân Ca gửi gắm lời chúc phúc vẹn toàn cho chủ sở hữu, gợi
          nhớ về những mùa Tết đoàn viên. Đồng thời thể hiện nghĩa tình gắn kết
          giữa hai miền, tạo nên bản hòa ca tuyệt diệu của đất trời trước thềm
          xuân mới.
        </p>
      </div>
    ),
    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          Nam như hoa sen, hoa mai, hoa đào, dương xỉ… Họa tiết chủ đạo trên 2
          mặt chính của Lộc Bình là hình ảnh hoa sen được khắc họa đầy nghệ
          thuật và sống động. Hai mặt bên của thân bình còn được trang trí hình
          ảnh bốn linh vật long, lân, quy, phụng - tượng trưng cho sự thái bình
          và thịnh vượng đem đến nhiều may mắn, điềm lành. Phần cổ bình được
          trang trí bằng họa tiết hoa mai, hoa đào với vẻ đẹp rực rỡ, thắm tươi,
          đại diện cho tài lộc, phú quý nhằm gửi gắm thông điệp ý nghĩa về sự
          hưng thịnh, phát triển.
        </p>
        <p>
          Đặc biệt, hai bên cổ bình còn được trang trí thêm linh vật rồng Việt
          cách điệu - tượng trưng cho nòi giống Rồng – Tiên. Hình ảnh bốn con
          dơi tượng trưng cho sự may mắn, phước lộc, cùng những họa tiết khác
          như cá chép hay hoa dương xỉ, tượng trưng cho sự trường cửu (lâu dài)
          càng tôn lên nét sang trọng, ý nghĩa tinh tế của Lộc Bình. Hình ảnh
          hoa cúc ở đế bình tượng trưng cho kiết tường (an lành) cũng được thể
          hiện một cách khéo léo. Tất cả tạo nên bức tranh cảnh sắc mùa xuân,
          đầy sức sống và giàu nghệ thuật. Tuyệt tác được đội ngũ nghệ nhân tài
          hoa nhất của Minh Long kỳ công chế tác vừa có giá trị mỹ thuật cao,
          vừa mang thông điệp, lời chúc phước - lộc - thọ, may mắn, an lành đến
          chủ sở hữu.
        </p>
      </div>
    ),
    instruction: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          hiện. Mỗi tác phẩm được hình thành từ chính đôi tay tài hoa của người
          thợ xoay bình cần mẫn, nét cọ khéo léo, tinh tế của người thợ vẽ và sự
          góp sức miệt mài của bao nghệ nhân khác.
        </p>
        <p>
          Mỗi bình hoa mang một phong cách với những cảm xúc riêng, như đất đã
          được thổi vào hơi thở của chính những người tạo ra nó. Trên mỗi tác
          phẩm, thiên nhiên và cuộc sống được tái hiện sống động, có hồn với đầy
          đủ các màu sắc của tình yêu, quê hương, đất nước, con người, gắn với
          ước vọng bình an, sung túc, thịnh vượng,... Những phong cách ấy được
          phối kết hài hòa trên những kiểu dáng Đông – Tây, tạo nên bao không
          gian vừa cổ kính, ấm cúng mà vẫn hiện đại, sang trọng, phù hợp với
          nhiều cách bày trí ở những không gian khác nhau.
        </p>
        <p>
          Nhờ ứng dụng công nghệ nano và vẽ màu ở nhiệt độ cao nên màu chìm dưới
          men, những nét vẽ khéo léo còn được giữ nguyên vẹn, hình ảnh trên sản
          phẩm có chiều sâu và sống động như thật.
        </p>
      </div>
    ),
    code: "A001_694535520",
    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          nhụy đã được tái hiện sống động bằng màu xanh cobalt đặc trưng của
          cung đình Huế. Bức tranh chân thực và sống động về lá, cỏ và hoa sen
          như đưa người ngắm về với một làng quê Việt Nam vốn yên bình, trù
          phú... Nghệ nhân cũng khéo léo tạo nét vương giả bằng những chi tiết
          vẽ vàng 24k uyển chuyển trên từng cánh hoa, vành, tay cầm và nắp tạo
          nên sắc màu lấp lánh dưới sự phản chiếu của ánh sáng. Bộ sản phẩm
          thích hợp cho những buổi sum họp thân tình trong không gian yên bình,
          thư giãn vừa gần gũi vừa sang trọng.
        </p>
      </div>
    ),
    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          thể hiện trọn vẹn sự sống động bằng sắc đen quý phái. Những chi tiết
          vẽ vàng 24k uyển chuyển trên từng cánh hoa, vành, tay cầm và nắp giúp
          sản phẩm thêm phần cao quý. Huyền Liên thích hợp cho những buổi đón
          tiếp khách mời quan trọng của gia đình. Sản phẩm giữ nhiệt ổn định,
          giúp thức uống nóng lâu và lưu giữ hương vị thơm ngon đặc trưng. Bộ
          trà Huyền Liên cũng là chế tác đặc biệt dành tặng Nguyên Thủ các quốc
          gia ASEAN 2020.
        </p>
      </div>
    ),
    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p className="italic">
          ...
          Long ứng dụng thêm kỹ thuật chế tác phủ lớp sương mờ, tạo cảm giác mềm
          mượt như nhung. Khải Đức chạm đến sự sang trọng cho mọi không gian,
          tỏa sáng những giá trị đẹp của chủ sở hữu.
        </p>
        <p>
          "Như thép đã tôi qua lửa” để hóa Rồng, Khải Đức có tạo hình nổi bật
          với vẻ đẹp trong như ngọc mà vẫn rạng ngời nét quyền quý và oai phong.
          Dáng Rồng uyển chuyển tựa một thước phim tái hiện hành trình vượt Vũ
          Môn của những chú cá chép tràn đầy năng lượng, sẵn sàng cuộc chinh
          phục mới. Từ bộ phận nâng đỡ như thân, đuôi đến các hình ảnh đắt giá
          được trang trí vàng ở phần đầu linh vật đều toát lên phong thái khỏe
          khoắn, khoan thai. “Hóa Rồng” thành công, Khải Đức không “ngủ quên”
          trong chiến thắng, vừa phun nước đem lại sức sống cho muôn loài, vừa
          chủ động với những chuyển biến mới.
        </p>
        <p>
          Ánh sáng lấp lánh của viên châu càng tôn thêm giá trị của linh vật.
          Viên châu là tinh hoa của tạo hóa, tượng trưng cho thành quả đạt được
          sau khi vượt khó khăn, cũng là biểu tượng cho những phẩm chất cao quý
          của con người. Chi tiết này không chỉ trang trí, mà còn kết hợp với
          đôi mắt sáng long lanh của Rồng Khải Đức luôn hướng về viên châu, thể
          hiện tinh thần vươn lên phía trước, hướng đến những giá trị tốt đẹp
          trong cuộc sống.
        </p>
        <p>
          Cá chép hóa Rồng phải vượt Vũ Môn, con người muốn thành công cần kiên
          trì, nhẫn nại, trau dồi kiến thức và rèn luyện kỹ năng. Khải Đức là
          lời chúc thăng tiến trong sự nghiệp, thịnh vượng trong cuộc sống, may
          mắn và tài lộc trong vạn sự. Mong tất cả thăng hoa, bay lên đẹp đẽ và
    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          người phương Đông đặc biệt trân quý. Tượng kỳ lân tám màu của Minh
          Long I là tác phẩm mỹ nghệ hiện thực hóa sinh động nét văn hóa dân
          gian vốn có nhưng không kém phần vương giả, hiện đại.
        </p>
        <p>
          Kỳ lân có đôi tai vểnh về phía sau, chân ôm quả cầu đầy uy phong.
          Miệng linh vật ngậm ngọc, há rộng, đôi mắt to tròn, sáng long lanh như
          thu vào tầm mắt mọi chuyển biến xung quanh, sẵn sàng chống lại cái ác.
          Những nét vẽ vàng ở chân, vành tai, khóe mắt, răng, vảy kết hợp với
          lối cách tân quyền quý bằng những đồng tiền vàng ở đai cổ kỳ lân đã
          nhân cách hóa một linh vật thiêng liêng mà gần gũi, uy dũng mà hiền
          hòa, cổ kính nhưng sang trọng.
        </p>
        <p>
          Lấy ý tưởng từ thuyết ngũ hành tương sinh Kim, Mộc, Thủy, Hỏa, Thổ, bộ
          tượng kỳ lân tám màu (năm màu chính và ba màu phụ) của Minh Long I
          gồm: Vàng, trắng, xanh lá, xanh dương, đỏ, cam, nâu và đen được tô vẽ
          hoàn toàn thủ công, có màu sắc tươi tắn. Tác phẩm là khối chắc chắn,
          láng mịn, có kích thước nhỏ gọn nhằm đáp ứng nhu cầu đa dạng theo sở
          thích, lứa tuổi, ứng với từng cung mạng và lựa chọn bày trí của gia
          chủ.
        </p>
        <p>
          Tượng kỳ lân mang đến điềm lành là lời chúc đất nước thái bình thịnh
    ...
    instruction: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          Long dù làm gì cũng không đi khỏi tiêu chí "Bốn không, bốn có", tức
          không biên giới, không thời gian, không giới tính, không tuổi tác và
          có văn hóa, có nghệ thuật, có phong cách, có hồn...
        </p>
        <p>
          Tượng là dòng sản phẩm cao cấp không chỉ bởi sự tinh tế, kiểu dáng độc
          đáo mà còn hội tụ cả cái tâm, cái tài của từng nghệ nhân thực hiện.
          Mỗi tác phẩm được hình thành từ chính đôi tay tài hoa của người nghệ
          nhân cần mẫn, nét cọ khéo léo, tinh tế.
        </p>
        <p>
          Những phong cách ấy được phối kết hài hòa trên những kiểu dáng Đông –
          Tây, tạo nên bao không gian vừa cổ kính, ấm cúng mà vẫn hiện đại, sang
          trọng, phù hợp với nhiều cách bày trí ở những không gian khác nhau.
        </p>
        <p>
          Nhờ công nghệ vẽ màu ở nhiệt độ cao nên màu chìm dưới men, những nét
          vẽ khéo léo còn được giữ nguyên vẹn, hình ảnh trên sản phẩm có chiều
          sâu và sống động như thật.
        </p>
      </div>
    ),
    ...
    description: (
      <div className="space-y-2 text-sm tracking-normal text-gray-700 md:tracking-wide">
        <p>
          ...
          loài Nhân Thú bao hàm cả Đức Nhân và Đức Nghĩa, đi đứng, xoay chuyển
          đểu theo quy củ, chọn đất rồi mới đứng lên, không giẫm lên bất cứ vật
          gì đang sống, kể cả cỏ xanh. Tượng Kỳ Lân Minh Long chạm ngưỡng hoàn
          hảo, thần thái vô cùng sinh động, từng chi tiết được kỳ công chế tác,
          dáng uy dũng của Sư Tử, ánh mắt uy nghiêm của Rồng, mũi kì lạ của Lân,
          khuôn miệng hiền hoà, gương mặt chứa điềm lành, bộ lông chải chuốt
          ngay ngắn...Tất cả đều toát lên khí chất có thần, ẩn chứa trong đó một
          sức mạnh tâm linh lớn lao đủ tránh tà ngăn sát khí, hoá giải tam sát,
          có thể thay đổi gia vận, tài vận theo chiều hướng tốt như quan niệm
          tâm linh của người xưa. Tượng được chế tác hoàn toàn bằng thủ công,
          được tô vẽ với nhiều màu men khác nhau và được được trang trí thêm
          vàng, bạch kim làm cho sản phẩm tăng thêm vẻ uy nghi. Tượng Kỳ Lân
          Minh Long góp phần vào những tác phẩm gốm sứ mỹ nghệ có một không hai,
          được đánh giá cao bởi sự đẳng cấp và giá trị văn hoá tâm linh mang
          lại.
        </p>
      </div>
    ),
