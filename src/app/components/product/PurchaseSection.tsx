...
const PurchaseSection: React.FC<PurchaseSectionProps> = ({ 
  ...
  const handlePatternChange = useCallback((pattern: string, patternSlug: string) => {
        ...
        <div className="flex items-center gap-x-6">
          <div className="flex items-center border border-gray-300 rounded-lg">
            ...
            <Input
              ...
              className={`w-12 p-0 text-center rounded-none border-none text-sm tracking-wide ${montserrat.className} ${
          ...
          <div className={`text-sm text-gray-600 tracking-wide ${montserrat.className}`}>
      ...
      <div className="flex flex-row gap-2 mt-6 md:mt-12 mb-8">
        {isOutOfStock ? (
          ...
          <>
            ...
            <button 
              className="mt-2 border border-[#BB9244] p-3 md:p-4 rounded-full w-full md:w-[60%] transition-colors flex items-center justify-center gap-x-2 md:gap-x-4 select-none bg-transparent text-[#BB9244] hover:bg-[#BB9244] hover:text-white active:bg-[#BB9244]/80 active:text-white/80 cursor-pointer"
            >
