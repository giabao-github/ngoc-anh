  ...
  "quat-tay-thach-am-naga-wind": {
    description: (
      <div className="space-y-4 text-sm tracking-normal text-gray-700 md:tracking-wide">
        ...
        <p>
          Chiếc quạt giấy "Naga Wind" là một tác phẩm nghệ thuật thu nhỏ, kết
          tinh từ nét đẹp truyền thống Khmer và tinh thần đương đại của thương
          hiệu Thạch Âm. Lấy cảm hứng từ họa tiết linh vật, chim thần, hoa sen,
          và chùa Khmer cổ, chiếc quạt không chỉ là vật phẩm thủ công mà còn là
          biểu tượng của di sản văn hóa và âm thanh linh thiêng.
        </p>
        <p>
          “Naga Wind” không đơn thuần là một chiếc quạt, mà là làn gió mang theo
          thanh âm di sản – nơi nghệ thuật và tâm linh Khmer hội tụ trong từng
          đường nét. Đây là lời tri ân sâu sắc đến những giá trị cổ truyền của
          người Khmer Nam Bộ, đặc biệt là vùng Trà Vinh – nơi khởi nguồn thương
          hiệu Thạch Âm.
        </p>
        <div className="space-y-2">
          <p>Điểm nổi bật của Quạt Tay Thạch Âm:</p>
