          ...
          <div className="text-center flex flex-col gap-y-3">
            ...
            >
              <div className="rounded-md space-y-6">
                ...
                <div className="relative">
                  <input
                    ...
                    onFocus={() => { if (!isTouched) setIsTouched(true); }}
                    required
              ...
              <div className="flex justify-center space-x-2 text-sm font-semibold tracking-wide">
                <a href="#" className="text-[#D4AF37] hover:text-[#D4AF37]/70">Quên mật khẩu?</a>
                <p className="text-gray-400 font-normal">hoặc</p>
                <a href="#" className="text-[#D4AF37] hover:text-[#D4AF37]/70">Đăng ký</a>
              </div>
